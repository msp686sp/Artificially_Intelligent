...
def _load_long_fixture(con, table: str, value_col: str, csv_path: Path) -> None:
    ...
    # Both raw_zillow_zhvi and raw_zillow_zori share the same wide shape
    # (region_id, zcta5, state, metro, county_name, observation_date,
    # <value>, snapshot_date) since the Phase 1 yield agent normalized them.
    df["region_id"] = "0"
    df["state"] = "CA"
    df["metro"] = "Synthetic"
    df["county_name"] = "Test"
